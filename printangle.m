...
function printangle(degrees) % function to convert degrees to radians
fprintf('Conversion from degrees to radians is: %.3f\n',degrees) 
% fprintf statement showing "degrees" conversion to radians round to two decimal places
end % end function